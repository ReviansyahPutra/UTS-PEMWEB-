            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        <img src="{{Storage::url($course->cover)}}" class="w-full h-full rounded-full object-contain"
                            alt="icon">
                        ...
                        @elseif ($course->category->name == 'Digital Marketing')
                            <p
                                class="p-[8px_16px] rounded-full bg-[#FFF2E6] font-bold text-sm text-[#066DFE] absolute bottom-0 transform -translate-x-1/2 left-1/2 text-nowrap">
                                {{$course->category->name}}
                            </p>
                        @endif
                    </div>
            ...
            @if($errors->any())
                <ul>
                    @foreach ($errors->all() as $errors)
                        <li class="py-5 px-5 bg-red text-white">
                            {{$errors}}
                        </li>
                    @endforeach
                </ul>
