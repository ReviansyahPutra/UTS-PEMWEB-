            ...
            @if ($errors->any())
                <ul>
                    @foreach ($errors->all() as $error)
                        <li class="py-5 px5 bg-red-700 text-white">
                            {{$errors}}
                        </li>
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('dashboard.courses.update', $course)}}"
                ...
                <div class="flex gap-5 items-center">
                    <input type="file" name="cover" id="icon" class="peer hidden" onchange="previewFile()"
                        data-empty="true">
                    <div
                        class="relative w-[100px] h-[100px] rounded-full overflow-hidden peer-data-[empty=true]:border-[3px] peer-data-[empty=true]-dashed peer-data-[empty=true]:border-[#EEEEEE]">
